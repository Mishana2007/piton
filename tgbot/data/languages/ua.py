...
class Texts:
    ...
    # Меню пользователя
    products = "🛍️ Каталог"
    back_to_products = "⬅ Повернутися до списку категорій"
    profile = "👤 Профіль"
...
"""
    ...
    no_faq_text = "<b>🔔 Всі актуальні новини про поповнення товарів, а також різних конкурсах ви можете дізнатися нашому новинному каналі!</b>"
    faq_chat_inl = "💬 Чат"
    ...
    refill_check_inl = "♻️ Перевірити оплату"
...
{desc}
    ...
    no_products = f"<b>На жаль в даний момент немає товару. Якщо вам потрібен товар даної категорії - @Moller_Market_Support</b>"
    no_product = f"На жаль в даний момент немає товару. Якщо вам потрібен товар даної категорії - @Moller_Market_Support"
