...
⚙️ Now you have <code>{user_ref_count}</code> {convert_ref}!</b>"""
    ...
    # Меню пользователя
    products = "🛍️ Catalog"
    back_to_products = "⬅ Back to the list of categories"
    profile = "👤 Profile"
...
{mss}"""
    ...
    no_faq_text = "<b>🔔 You can find out all the latest news about the replenishment of goods, as well as various contests on our news channel!</b>"
    faq_chat_inl = "💬 Chat"
    faq_news_inl = "🗞 News channel"
    ...
    refill_check_inl = "♻️ Check payment"
...
{desc}"""
    ...
    no_products = f"<b>Unfortunately, there is no product at the moment. If you need a product of this category - @Moller_Market_Support</b>"
    no_product = f"Unfortunately, there is no product at the moment. If you need a product of this category - @Moller_Market_Support"
