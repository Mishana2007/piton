...
async def open_pod_cat_positions(texts, pod_cat_id):
    ...
    keyboard.add(InlineKeyboardButton(texts.back_to_products, callback_data=f"products:open"))
...
async def open_positions(texts, cat_id):
    ...
    keyboard.add(InlineKeyboardButton(texts.back_to_menu, callback_data="back_to_user_menu"))
